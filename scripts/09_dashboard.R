...
server <- function(input, output, session) {
  ...
  data_list <- reactive({
    ...
    if (input$irf_type == "standard") {
      df1 <- readr::read_csv("../csv/irf_full_order_1.csv", show_col_types = FALSE)
      df2 <- readr::read_csv("../csv/irf_full_order_2.csv", show_col_types = FALSE)
    } else {
      df1 <- readr::read_csv("../csv/irf_cumulative_order_1.csv", show_col_types = FALSE)
      df2 <- readr::read_csv("../csv/irf_cumulative_order_2.csv", show_col_types = FALSE)
    }
